...
<section class="about-me js__about-me" id="link__about-me">
	<div class="container">
		<img src="resources/img/headshot.jpg" alt="Sanchay Javeria's headshot.">
		<h3>Oh hey, Hi!</h3>
	</div>
	<div class="container">
...
<section class="skills js__skills" id="link__skills">
	<div class="container">
		...
		<h3 id="top-h3">More than just fresh eggs..</h3>
	</div>
	<div class="container">
		...
		<div class="col span-1-of-4 box2">
			...
			<p><b>Technologies:</b> HTML5, CSS3, JQuery<br> <b>Languages:</b> Javascript<br> <b>Frameworks:</b> NodeJS, Flask, Bootstrap, semanticUI<br> <b>Node packages:</b> Express, Mongoose, Ejs, Passport, etc.<br> <b>Databases:</b> MongoDB, postgreSQL, MySQL<br></p>
		</div>
		<div class="col span-1-of-4 box3">
			<i class="icon-mobile"></i>
			<h3 id="inner-h3">Mobile</h3>
			<p><b>Languages:</b> Swift 2, Swift 3<br> <b>IDE:</b> XCode <br><b>Frontend:</b> Interface builder (Main Storyboard)<br> <b>Backend:</b> Firebase<br><b>Packages (Pods):</b> Alamofire, SwiftString, etc.</p>
		</div>
          	...
          	<div class="container">
				<div class="col span-1-of-2" id="img-box">
    	      	...
    	      	<div class="col span-1-of-2" id="desc">
					...
					<ul>
						<li>The application is written in <strong>Swift 2</strong> using XCode 7.3.1 IDE </li>
						<li>The front-end is build in the <strong>main-storyboard (interface builder)</strong></li>
						<li>The back-end is hosted on <strong>Firebase</strong> </li>
						<li>Networking pod called <strong>Alamofire</strong> used to make post/get requests to Firebase </li>
						<li>Follows google's <strong>material design</strong> principles and is a <strong>socket based application</strong></li>
          ...
          <div class="container">
          	...
          	<div class="col span-1-of-2" id="desc">
          		...
          		<ul>
					<li>The application is written in <strong>Swift 2</strong> using XCode 7.3.1 IDE </li>
					<li>The front-end is build in the <strong>main-storyboard (interface builder)</strong></li>
					<li>The application consume <strong>pokeAPI</strong> to pull information about 718 pokemons</li>
                ...
                <div class="container">
                    ...
                    <div class="col span-2-of-3">
                        <select name="reason" id="reason">
                            <option value="Hire" selected>I want to hire you!</option>
                            <option value="Hello">Just swung by to say hello :)</option>
...
<script type="text/javascript" src="external/js/typer.js"></script> <!-- typer -->
